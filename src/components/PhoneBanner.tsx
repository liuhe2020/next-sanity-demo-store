...
export default function PhoneBanner() {
  return (
    <section className='relative text-stone-300 w-full h-[530px] max-w-[2560px] mx-auto flex flex-col items-center overflow-hidden md:h-[750px] lg:h-[1000px]'>
      ...
      <Image className='object-cover w-[700px] md:w-[1000px] -z-10 lg:hidden' src='/images/hero_phone.jpg' alt='hero phone' fill sizes='100vw' />
      <Image className='object-cover object-[50% 45%] -z-10 hidden lg:block' src='/images/hero_phone_lg.jpg' alt='hero phone' fill sizes='100vw' />
    </section>
  );
}
