                  ...
                  <dl className='space-y-3 text-sm text-stone-600 pb-6 border-b border-stone-300'>
                    ...
                    <div className='flex'>
                      ...
                      <dd className='ml-2 text-stone-900'>
                        <time dateTime={order._createdAt}>{order._createdAt}</time>
                      </dd>
                    </div>
                    <div className='flex'>
                    ...
                    <div className='flex'>
                      ...
                      <dd className='ml-2 text-stone-900'>£{order.orderTotal.toFixed(2)}</dd>
                    </div>
                  </dl>
                  ...
                  <table className='w-full text-stone-500 mt-4'>
                    <thead className='sr-only text-sm text-stone-500 text-left sm:not-sr-only'>
                      <tr>
                        ...
                        <th scope='col' className='hidden w-1/12 py-2 font-medium sm:table-cell'>
                          Price
                        </th>
                      </tr>
                    </thead>
                          ...
                          <td className='pt-5'>
                            <div className='flex items-center'>
                              ...
                              <div>
                                ...
                                <div className='mt-1 sm:hidden text-stone-900'>£{item.product.price.toFixed(2)}</div>
                              </div>
                            </div>
                          </td>
                          <td className='hidden pt-6 sm:table-cell text-stone-900'>£{item.product.price.toFixed(2)}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
