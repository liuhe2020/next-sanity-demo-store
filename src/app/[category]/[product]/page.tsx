      ...
      <section className='pt-16'>
        <div className='max-w-screen-lg py-4 px-4 space-y-12 lg:space-y-0 lg:flex lg:mx-auto lg:space-x-6 lg:p-10'>
          <div className='flex-1 max-w-xl mx-auto'>
            <ImageGallery items={images} showNav={false} showFullscreenButton={false} useBrowserFullscreen={false} showPlayButton={false} />
          </div>
          ...
          <div className='flex-1 max-w-xl mx-auto'>
            <div className='w-full h-full flex flex-col lg:pt-[9%] lg:pl-[10%]'>
              ...
              <div className='flex space-x-2 mb-8 text-xs min-[400px]:max-[1023px]:mx-4 lg:text-sm lg:mb-10'>
                <div className='flex relative flex-nowrap space-x-1' title={product.rating}>
                  {[1, 2, 3, 4, 5].map((el) => (
                    <svg
                      key={el}
...
export async function getStaticProps({ params }) {
  ...
  const product = await client.fetch(`*[slug.current == '${params.product}'][0]`);
