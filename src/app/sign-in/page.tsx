...
export default function SignIn() {
  ...
  return (
    <>
      <Head>
        <title>DS | Sign In</title>
        <link rel='shortcut icon' href='/images/favicon.ico' />
      </Head>
      <section className='pt-16 min-h-[80vh]  flex flex-col justify-center sm:px-6 lg:px-8 bg-stone-50'>
        <div className='sm:mx-auto sm:w-full sm:max-w-md'>
          <h2 className='mt-6 text-center text-3xl font-extrabold text-stone-800'>Sign in to Next Sanity Demo Store</h2>
        </div>
